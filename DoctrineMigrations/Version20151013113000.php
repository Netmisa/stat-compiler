    ...
    public function up(Schema $schema)
    {
        $this->addSql('
            ...
            (
              ...
              nb integer,
              CONSTRAINT coverage_modes_pkey PRIMARY KEY (request_date, region_id, type, mode, commercial_mode_id, commercial_mode_name, is_internal_call)
            )
            WITH (
              OIDS=FALSE
            );
            ...
            BEGIN
              ...
              IF NOT EXISTS(SELECT 1 FROM pg_tables WHERE tablename=partition and schemaname=schema) THEN
                ...
                EXECUTE \'CREATE TABLE IF NOT EXISTS \' || schema || \'.\' || partition ||
                        \' (CONSTRAINT \' || partition || \'_pkey PRIMARY KEY (request_date, region_id, type, mode, commercial_mode_id, commercial_mode_name, is_internal_call),
